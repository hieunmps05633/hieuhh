                        ...
                        <div class="container-fluid">
                            ...
                            <div class="topnav">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="student.htm" data-toggle="onoffcanvas" class="btn btn-default btn-sm" aria-expanded="false">
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapseOne" class="body">
                ${message}
              <form:form  class="form-horizontal" id="block-validate" action="sendmail/send.htm" modelAttribute="student" >

                    <div class="form-group">
                        
                        <div class="col-lg-4">
                           
                            <input name="from" type="hidden" id="required2" class="form-control" value="trungplqps05630@fpt.edu.vn"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <form:input path="email" id="email2" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                             <input name="subject" id="password2"  class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-4">Confirm Password</label>
                        <div class="col-lg-4">
                            <form:input path="mark" type="hidden" rows="3" cols="30" class="form-control" id="confirm_password2" /> 
                            <input type="hidden" name="body" value="Tong Thanh Tich Hien Tai cua ban : ${student.mark}"/>
