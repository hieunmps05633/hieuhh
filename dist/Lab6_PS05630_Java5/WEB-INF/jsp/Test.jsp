        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                 <table width="100%" class="table table-striped table-bordered table-hover" >
                                    ...
                                    ${message}
                                    <form:form action="Test.htm" modelAttribute="student" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input path="username" cssClass="form-control" name="txtName"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Ngày sinh</label>
                                            <form:input path="password" cssClass="form-control" name="txtPass"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Thưởng</label>
                                            <form:input path="lastname" cssClass="form-control" name="txtLast"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Thưởng</label>
                                            <input type="file" path="image" cssClass="form-control" name="txtCV"/>
                                        </div>
                                    ...
                                    <c:forEach var="m" items="${student}">
                                        <tr>
                                            <td>${m.id}</td>
                                            <td>${m.username}</td>
                                            <td>${m.password}</td>
                                            <td>${m.lastname}</td>
                                            <td><img src="img/${m.image}"</td>
                                        </tr>
                                    </c:forEach>
